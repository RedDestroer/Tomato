...
Основная задача - выставить API для single-page приложения, которое
выплёвывается тут же из этого API с дефолтной точки.

Есть несколько публичных точек, но все остальные должны быть
авторизованы через Auth0

Само приложение - SPA на React.
